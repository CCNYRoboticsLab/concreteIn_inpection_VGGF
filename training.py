...
def testbatch(fls):
    ...
    for i,f in enumerate(fls):
        ...
        imi=cv2.imread('/home/ericyanng/ericFiles/deepLN/theano/project/detectionOfSpalling/YL_50iter.npz/imageClusters/'+fname)
...
def imdata(fls):
    ...
    for i,f in enumerate(fls):
        fname,flabel=f.split(',')
        imi=cv2.imread('/home/wei/caffedata/YL_proj/imageClusters/'+fname)
        #cv2 read img as 3xNxN and with BGR
...
listtrainpath='/home/ericyanng/ericFiles/deepLN/theano/project/detectionOfSpalling/train_list.txt'
listtestpath='/home/ericyanng/ericFiles/deepLN/theano/project/detectionOfSpalling/test_list.txt'
impath='/home/ericyanng/ericFiles/deepLN/theano/project/detectionOfSpalling'
